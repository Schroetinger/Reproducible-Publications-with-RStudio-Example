...
csl: developmental-biology.csl
nocite: | 
  @wickham2019a, @nitsch2020a
---
...
**Inline example (Extra Example)** The mean value for PANAS1_1 is `r mean(df$PANAS1_1)`
